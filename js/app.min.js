...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _js_swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/swiper-bundle.min.js */ \"./src/js/swiper-bundle.min.js\");\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\n// Swiper JS\r\n\r\n\r\nconst swiper = new Swiper('.swiper', {\r\n  // Optional parameters\r\n  slidesPerView: 1,\r\n  spaceBetween: 30,\r\n  direction: 'horizontal',\r\n  loop: true,\r\n\r\n  // If we need pagination\r\n  pagination: {\r\n    el: '.swiper-pagination',\r\n    clickable: true,\r\n  },\r\n  // Navigation arrows\r\n  navigation: {\r\n    nextEl: '.swiper-button-next',\r\n    prevEl: '.swiper-button-prev',\r\n  },\r\n\r\n  // And if we need scrollbar\r\n  scrollbar: {\r\n    el: '.swiper-scrollbar',\r\n  },\r\n\r\n});\r\n\r\n// / Swiper JS\r\n\r\n// Burger Menu \r\n\r\nconst burgerBtn = document.querySelector('.header-menu__item');\r\nconst nav = document.querySelector('.header-nav');\r\nconst btn = document.querySelector('.header-btn');\r\nburgerBtn.addEventListener('click', () => {\r\n  burgerBtn.preventDefault;\r\n  burgerBtn.classList.toggle('isActive');\r\n  if (burgerBtn.classList.contains('isActive') === true) {\r\n    nav.style.visibility = 'visible'\r\n  } else {\r\n    nav.style.visibility = 'hidden'\r\n  }\r\n})\r\n\r\n// / Burger Menu\r\n\n\n//# sourceURL=webpack://gulplayout/./src/js/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"isWebp\": () => (/* binding */ isWebp)\n/* harmony export */ });\n// Проверка поддержки WEBP если true то присваевается класс webp \r\n// В протвном случае присваевается no-webp\r\nfunction isWebp() {\r\n  function testWebP(callback) {\r\n\r\n    let webP = new Image();\r\n    webP.onload = webP.onerror = function () {\r\n      callback(webP.height == 2);\r\n    };\r\n    webP.src = \"data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA\";\r\n  }\r\n\r\n  testWebP(function (support) {\r\n\r\n    if (support == true) {\r\n      document.querySelector('body').classList.add('webp');\r\n    } else {\r\n      document.querySelector('body').classList.add('no-webp');\r\n    }\r\n  });\r\n}\r\n\n\n//# sourceURL=webpack://gulplayout/./src/js/modules/functions.js?");
